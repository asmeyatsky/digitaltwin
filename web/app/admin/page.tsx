...
export default function AdminDashboard() {
  ...
  const quickLinks = [
    ...
    { label: "View Emotion Insights", href: "/admin/insights", description: "Analyze emotional analytics and trends" },
    { label: "Manage Community", href: "/admin/community", description: "Browse community groups and posts" },
    { label: "Verify Therapists", href: "/admin/therapists", description: "Review therapist credentials" },
    { label: "Learning Paths", href: "/admin/learning", description: "View and manage educational content" },
